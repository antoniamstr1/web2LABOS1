...
```json
{
  ...
  "appOrigin": "{OPTIONAL: THE BASE URL OF YOUR APPLICATION (https://web2-lab1-8sa6.onrender.com/)}",
  "apiOrigin": "{OPTIONAL: THE BASE URL OF YOUR API (https://web2-lab1-8sa6.onrender.com/)}"
}
```
